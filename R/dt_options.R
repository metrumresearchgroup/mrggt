...
dt_options_tbl <-
  dplyr::tribble(
    ...
    "table_optimize_font",                TRUE,  "table",            "logical", TRUE,
    "table_optimize_width",               TRUE,  "table",            "logical", TRUE,
    ...
    "footnotes_align",                    TRUE,  "footnotes",        "value",   NA_character_,
    ...
    "source_notes_align",                 TRUE,  "source_notes",     "value",   NA_character_,
