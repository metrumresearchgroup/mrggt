...
.onLoad <- function(libname, pkgname, ...) {
  ...
  registerS3method("cell_style_to_latex", "cell_text", "cell_style_to_latex.cell_text")
  registerS3method("cell_style_to_latex", "cell_border", "cell_style_to_latex.cell_border")
  registerS3method("cell_style_to_latex", "cell_fill", "cell_style_to_latex.cell_fill")
  registerS3method("cell_style_to_latex", "cell_styles", "cell_style_to_latex.cell_styles")
  registerS3method("cell_style_to_latex", "default", "cell_style_to_latex.default")
