...
\StringTok{  }\KeywordTok{tab_style}\NormalTok{(}
    \DataTypeTok{style =} \KeywordTok{list}\NormalTok{(}\KeywordTok{cell_text}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#ffcccb"}\NormalTok{,}
                           \DataTypeTok{weight =} \StringTok{'bold'}\NormalTok{),}
                 \KeywordTok{cell_fill}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#ffffed"}\NormalTok{)),}
